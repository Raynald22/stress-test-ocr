// Shared k6 result saver. Every script that imports this and does
...
//
// NOTE: run k6 from inside this qa-stress folder so ./results resolves. The
// results/ folder already exists in this repo.
